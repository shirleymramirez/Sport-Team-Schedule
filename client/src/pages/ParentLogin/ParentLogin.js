...
import * as parentloginActionCreators from "./parentloginActionCreators";
                ...
                <CardActions>
                  <CardActionButtons>
                    ...
                    <Typography>
                      <span>
                        <CardAction>
                          <Link className="Link" to="/parent/signup">
                            <h4>Sign up</h4>
                          </Link>
                        </CardAction>
                      </span>
...
const mapDispatchToProps = (dispatch) => {
  return { actions: bindActionCreators(parentloginActionCreators, dispatch) };
};
